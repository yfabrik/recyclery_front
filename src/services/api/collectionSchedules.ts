...
export const getCollectionReceipt =(id:number)=>axiosInstance.get(`/api/collection-schedules/${id}/receipt`)

export const createCollectionReceipt = (id:number,data)=>axiosInstance.post(`/api/collection-schedules/${id}/receipt`,data)