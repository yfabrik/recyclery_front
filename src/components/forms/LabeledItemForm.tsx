...
interface LabeledFormProps extends BaseFormProps<Schema> {
  ...
  setShowWeightKeypad: (b: boolean) => void,
  setShowPriceKeypad: (b: boolean) => void,
    ...
    <form id={formId} onSubmit={form.handleSubmit(onSubmit)}>
      <Grid container spacing={2} sx={{ mt: 1 }}>
        <Grid size={{ xs: 12, md: 6 }}>
          <FormSelect control={form.control} label="Catégories" name="category_id">
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          <FormInput control={form.control} name="weight" label="Poids (kg)" extra={{
            type: "number",
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          <FormInput control={form.control} name="price" label="Prix de vente (€)" extra={{
            type: "number",
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          <FormSelect control={form.control} name="condition_state" label="État">
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          <FormInput control={form.control} name="location" label="Emplacement" extra={{
        ...
        <Grid size={{ xs: 12 }}>
          <FormInput control={form.control} name="description" label="Description" extra={{
            multiline: true,
            rows: 3,
